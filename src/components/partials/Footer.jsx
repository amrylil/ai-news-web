      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
          <div className="flex items-center space-x-3">
            <div className="relative group">
              ...
              <div
                className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-500 opacity-0 blur-lg group-hover:opacity-30 transition-opacity duration-300"
                style={{ borderRadius: "10px" }}
              ></div>
            </div>
            <div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200/60 text-center">
          <p className="text-sm text-gray-500">
            &copy; 2024 NewsHub. Crafted with
